...
<body>
    <div class="invoice">
        <div class="invoice-content">
            <h1 class="orderNumber">Coupon #{{ $order->id }}</h1>
            ...
            <table>
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td class="total-amount" colspan="2">Rs. {{ rtrim(rtrim(number_format($order->grand_total, 2), '0'), '.') }}</tt>
                    </tr>
                    <tr>
                        <td style="text-align:center;" colspan='3'>
                            <hr style="border: 2px dotted #000000; border-style: none none dotted; color: #fff; background-color: #fff;">
                    ...
                    <tr>
                        <td class="total">Received Total</td>
                        <td class="total-amount" colspan="2">Rs. {{ rtrim(rtrim(number_format($order->received_amount, 2), '0'), '.') }}</tt>
                    </tr>
                    <tr>
                        <td class="total">Balance</td>
                        <td class="total-amount" colspan="2">Rs. {{ rtrim(rtrim(number_format($order->return_amount, 2), '0'), '.') }}</tt>
                    </tr>
                    <tr>
                        <td style="text-align:center;" colspan='3'>
                            <hr style="border: 2px dotted #000000; border-style: none none dotted; color: #fff; background-color: #fff;">
